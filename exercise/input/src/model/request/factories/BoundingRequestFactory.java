...
public class BoundingRequestFactory {
    ...
    public static Request<Integer> makeIntegerBoundRequest(String prompt, String message, String exitCode, int lowerBound, int upperBound){
    ...
    public static Request<Character> makeCharacterBoundRequest(String prompt, String message, String exitCode, char lowerBound, char upperBound){
        ...
        return new BoundingRequest<Character>(prompt, message, exitCode, sanitizer, lowerBound, upperBound);
    }
}
